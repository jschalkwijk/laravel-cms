...
<header class="header_area">
	<div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
		...
		<nav class="classy-navbar" id="essenceNav">
			<!-- Logo -->
			<a class="nav-brand" href="../index.blade.php"><img src="../assets/img/core-img/logo.png" alt=""></a>
			<!-- Navbar Toggler -->
					...
					<ul>
						<li><a href="#">Shop</a>
							<div class="megamenu">
								<ul class="single-mega cn-col-4">
									...
									<li><a href="../shop.blade.php">Dresses</a></li>
									<li><a href="../shop.blade.php">Blouses &amp; Shirts</a></li>
									<li><a href="../shop.blade.php">T-shirts</a></li>
									<li><a href="../shop.blade.php">Rompers</a></li>
									<li><a href="../shop.blade.php">Bras &amp; Panties</a></li>
								</ul>
								<ul class="single-mega cn-col-4">
									<li class="title">Men's Collection</li>
									<li><a href="../shop.blade.php">T-Shirts</a></li>
									<li><a href="../shop.blade.php">Polo</a></li>
									<li><a href="../shop.blade.php">Shirts</a></li>
									<li><a href="../shop.blade.php">Jackets</a></li>
									<li><a href="../shop.blade.php">Trench</a></li>
								</ul>
								<ul class="single-mega cn-col-4">
						...
						<li><a href="#">Pages</a>
							<ul class="dropdown">
								...
								<li><a href="../single-product-details.blade.php">Product Details</a></li>
								...
								<li><a href="../regular-page.blade.php">Regular Page</a></li>
	...
	<div class="cart-content d-flex">
		...
		<div class="cart-amount-summary">
			...
			<div class="checkout-btn mt-100">
				<a href="../checkout.blade.php" class="btn essence-btn">check out</a>
			</div>
		</div>
	</div>
</div>
