                                        ...
                                        <div class="comment-body comment-{{$c->comment_id}}">
                                            ...
                                            <ul class="comment-date text-uppercase reviews list-inline">
                                                ...
                                                <li class="list-inline-item dd">
                                                    <table>
                                                        <tr>@include('JornSchalkwijk\LaravelCMS::admin.partials.comment-action',['single' => $c])</tr>
                                                    </table>
                                                </li>
                                            </ul>
                                                            ...
                                                            <li class="comment comment-replied ">
                                                                ...
                                                                <div class="comment-body comment-{{$c->comment_id}}">
                                                                    ...
                                                                    <ul class="comment-date text-uppercase reviews list-inline">
                                                                        ...
                                                                        <li class="list-inline-item dd">
                                                                            <table>
                                                                                <tr>@include('JornSchalkwijk\LaravelCMS::admin.partials.comment-action',['single' => $reply])</tr>
                                                                            </table>
                                                                        </li>
                                                                    </ul>
                                                                    <p class="comment-text">
