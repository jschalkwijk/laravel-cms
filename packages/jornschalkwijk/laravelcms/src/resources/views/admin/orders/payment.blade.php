    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <table id="cart-table" class="table table-sm table-striped">
                        ...
                        @foreach($order->products as $item)
                            <tr id="product-{{$order->product_id}}">
                                ...
                                <td class="align-middle">{{$item->tax_value * $item->getQuantity()}}</td>
                                <td class="align-middle">{{$item->productTotal()}}</td>
                            </tr>
            ...
            {{--<div id="cart-table" class="col-6 col-md-4">--}}
                ...
                {{--@if(count($cart->all()) != 0)--}}
                    {{--@include('JornSchalkwijk\LaravelCMS::admin.order.order-summary')--}}
                {{--@endif--}}
            {{--</div>--}}
        </div>
    </div>
